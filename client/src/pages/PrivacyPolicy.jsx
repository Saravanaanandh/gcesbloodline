    ...
    <div className="min-h-screen bg-white p-9">
      ...
      <div className="min-h-screen bg-gray-900 text-white p-6 sm:p-12 rounded-lg mt-7">
        <div className="max-w-4xl mx-auto space-y-5 bg-gray-800/80 border border-gray-700 rounded-lg p-6 sm:p-10 shadow-lg text-gray-300">
          <div className="privacy-content [&>h1]:text-3xl [&>h1]:font-bold [&>h1]:mb-6 [&>h2]:text-2xl [&>h2]:font-semibold [&>h2]:mt-8 [&>h2]:mb-4 [&>h3]:text-xl [&>h3]:font-medium [&>h3]:mt-6 [&>h3]:mb-3 [&>h4]:text-lg [&>h4]:font-medium [&>h4]:mt-4 [&>h4]:mb-2 [&>p]:mb-4 [&>ul]:list-disc [&>ul]:pl-6 [&>ul]:mb-4 [&>ul>li]:mb-2 [&_a]:text-blue-400 [&_a]:hover:underline">
            ...
            <li>
            <p><strong>Company</strong> (referred to as either &quot;the Company&quot;, &quot;We&quot;, &quot;Us&quot; or &quot;Our&quot; in this Privacy Policy) refers to GCES Bloodline.</p>
            </li>
            <li>
            ...
            <li>
            <p><strong>Website</strong> refers to GCES Bloodline, accessible from <a href="https://gcesbloodline.onrender.com" rel="external nofollow noopener noreferrer" target="_blank">https://gcesbloodline.onrender.com</a>.</p>
            </li>
            <li>
            ...
            <ul>
            <li>By email: bloodline.gces@gmail.com</li>
            </ul>
          </div>
        </div>
      </div>
